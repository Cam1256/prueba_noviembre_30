...
path = '/Users/cristiancamilocuevas/Desktop/14_11_2022_KAHOS_RESEARCH/Entrega_2/support2.csv'


outpath = '/Users/cristiancamilocuevas/Desktop/14_11_2022_KAHOS_RESEARCH/Entrega_2/support_snieves_out.csv'
...
dframe1 = pd.read_csv(outpath)
dframe1.columns = dframe1.columns.str.replace(';','')
dframe1['supportitemsets']=dframe1['supportitemsets'].map(lambda x: x.replace(';',','))
duty1 = dframe1['supportitemsets'].str.split(',', expand=True)

data_total = pd.concat([duty1, dframe1], axis = 1).drop('supportitemsets', 1)
...
net.show("/home/cristian/Desktop/Entrega_2/data/grafi.html")
